...
function gFont(name, trail, styleParam1, styleParam2) {
    let fstyle;
    let fweight;
    if (styleParam1 === undefined) {
        ...
        if (styleParam1 === "normal" || styleParam1 === "italic") {
            ...
            fstyle = "normal";
            if (typeof styleParam1 === "number")
                fweight = styleParam1;
            else
                fweight = Weights[styleParam1];
        }
    }
    else {
        if (styleParam1 === "normal" || styleParam1 === "italic") {
            fstyle = styleParam1;
            if (typeof styleParam2 === "number")
                fweight = styleParam2;
            else
                fweight = Weights[styleParam2];
        }
        else {
            if (typeof styleParam1 === "number")
                fweight = styleParam1;
